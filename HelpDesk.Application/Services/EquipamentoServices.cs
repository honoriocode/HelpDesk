...
namespace HelpDesk.Application.Services
{
    ...
    {
        public Task<ServiceResponse> Edit(Guid id, RequestEquipamentoViewModel request)
        {
            throw new NotImplementedException();
        }

        public Task<IQueryable<ResponseEquipamentoViewModel>> GetAll()
        {
            throw new NotImplementedException();
        }

        public Task<ResponseEquipamentoViewModel> GetById(Guid id)
        {
            throw new NotImplementedException();
        }
    }
